...
var saltRound = process.env.SALT;
var userModel = /** @class */ (function () {
    function userModel() {
    }
    userModel.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, users, error_1;
    ...
    userModel.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        exports.hash = bcrypt_1.default.hashSync(u.password, parseInt(saltRound));
                        return [4 /*yield*/, conn.query(sql, [u.first_name, u.last_name, exports.hash])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release;
    ...
    userModel.prototype.authenticate = function (id, password) {
        return __awaiter(this, void 0, void 0, function () {
